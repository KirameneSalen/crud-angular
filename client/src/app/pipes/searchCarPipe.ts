...
export class SearchCarPipe implements PipeTransform{
    transform(value: Car[], args: Car) {
        ...
        // return value.filter((obj: Car) => {
        //     return args.marca && REPLACE_DIACRITICS(obj.marca.toLowerCase()).includes(REPLACE_DIACRITICS(args.marca.toLowerCase())) &&
        //         args.model && REPLACE_DIACRITICS(obj.model.toLowerCase()).includes(REPLACE_DIACRITICS(args.model.toLowerCase)) &&
        //         args.an_fabricatie && obj.an_fabricatie === args.an_fabricatie &&
        //         args.capacitate_cilindrica && obj.capacitate_cilindrica === args.capacitate_cilindrica &&
        //         args.taxa_impozit && obj.taxa_impozit === args.taxa_impozit
        // })
        return value;
    }
}